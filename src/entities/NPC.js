...
export class NPC {
    ...
    setupNPCType() {
        switch (this.type) {
            case NPC_TYPES.DUKE_HORACIO:
                ...
                break;
            case NPC_TYPES.HANS:
                this.wanderRadius = 30; // Hans walks around the castle
                break;
            case NPC_TYPES.BOB:
    ...
    createMesh() {
        ...
        if (this.type === NPC_TYPES.GUARD) bodyColor = 0xB22222; // Red for guards
        else if (this.type === NPC_TYPES.DUKE_HORACIO) bodyColor = 0x9400D3; // Purple for duke
        else if (this.type === NPC_TYPES.FATHER_AERECK) bodyColor = 0x808080; // Gray for priest
